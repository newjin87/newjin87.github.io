---
layout: post
title: "[2026-02-22] Amazon (AMZN) - Deep Dive Analysis (English)"
...
## 📌 Executive Summary
Amazon's stock has declined 12% over the past year, despite strong performance and investment in AI. The company's significant investment in AI, totaling $200 billion this year, has raised eyebrows, but CEO Andy Jassy defends the strategy by highlighting Amazon's expertise in demand signals within AWS. AWS, the leading cloud business, demonstrates robust growth with a $142 billion run rate and a 24% year-over-year sales increase in Q4. One Wall Street analyst predicts a potential 79% gain in Amazon's stock this year, while the average consensus target estimates a 42% increase over the next 12-19 months.
...
- CEO Andy Jassy defends the AI investment, citing Amazon's experience in demand signals in AWS.

### Amazon Web Services (AWS)
- AWS is the world's largest cloud business.
...
At a current price of $210.11, Amazon presents a compelling valuation opportunity, reinforced by a "strong buy" recommendation. The analyst target mean of $280.5238 suggests a potential upside of approximately 33.5% from the current level. The more bullish target of $360.0 represents an even more substantial potential gain of around 71.3%, indicating a significant level of optimism from certain analysts. While the trailing Price-to-Earnings (PE) ratio of 29.34 appears high relative to historical averages, the forward PE of 22.63 suggests expectations of strong earnings growth in the coming year. This growth is critical and needs to materialize to justify the current market capitalization of $2.256 trillion. The absence of a dividend yield removes a component of shareholder return but is consistent with Amazon's focus on reinvesting profits to fuel further growth and innovation. The stock's price range over the past 52 weeks, between $161.38 and $258.6, establishes a reasonable volatility band, and current pricing suggests the stock is positioned closer to its yearly low than its high. This positioning, coupled with analyst forecasts, could signal an opportune time to consider an entry point.
The question is whether the future growth can justify the high valuation.

## 2. 📰 Key Drivers & Deep News Analysis

### (1) AI Investment & AWS Growth
- **Fact Check**: Amazon is investing aggressively in AI, with a planned $200 billion spend this year. CEO Andy Jassy defends this investment by highlighting Amazon's expertise in understanding demand signals within AWS and translating capacity into strong returns on invested capital. AWS saw a resurgence in growth in Q4 with 24% year-over-year growth to a $142 billion run rate, securing significant deals with Visa, Salesforce, DoorDash, and OpenAI.
...
- **📈 Bull Case**: Price target of $360, representing 71.3% upside. This relies on continued strong growth in AWS driven by AI adoption, successful monetization of AI investments through new services, sustained growth in advertising revenue, and effective cost management. Under this scenario, Amazon successfully integrates AI across its business segments, leading to increased efficiency, improved customer experience, and new revenue streams. The forward PE ratio declines as earnings outpace stock price growth. Macro conditions remain stable, allowing for consistent economic growth and consumer spending.
- **📉 Bear Case**: Downside risk to $160, near the 52-week low. This scenario involves slower-than-expected growth in AWS due to increased competition or slower adoption of cloud services. Unsuccessful AI investments and monetization challenges could lead to missed revenue targets. A recession or slowdown in consumer spending could negatively impact e-commerce and advertising revenue. Potential regulatory pressures on large tech companies also present a downside risk. If earnings disappoint or the company's growth narrative falters, investors may re-evaluate the company's valuation and drive the stock price down.
